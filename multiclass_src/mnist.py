...
def train_mnist(loss_metric=None, epochs=None, imbalanced=None, run_name=None, seed=None, cuda=None, batch_size=None,
    ...
    if imbalanced:
        ...
        print("LOADING IN BALANCED DATA")
...
python3 mnist.py --loss="approx-ap" --epochs=2000 --batch_size=1024 --run_name="approx-ap" --cuda=1 --patience=100 --output_file="mnist-ap.json" 
