...
'''
python3 cifar_backup.py --epochs=1000 --imb --loss="approx-f1" --run_name="2048-approx-f1-imb" --cuda=1
python3 cifar_backup.py --epochs=1000 --imb --loss="ce" --run_name="2048-baseline-imb" --cuda=0
