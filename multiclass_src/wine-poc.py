...
def train_wine(data_splits, loss_metric, epochs, seed, run_name, cuda, train_tau, batch_size, patience, output_file):
    ...
    if run_name:
        ...
        tensorboard_path = "/".join(["tensorboard", "wine-poc", experiment_name])
    ...
    early_stopping_per_class = [False for i in range(4)]
    patience_classes = [int(patience) for i in range(4)]
    print("patience: {}".format(patience))
    reset_patience = [int(patience) for i in range(4)]

    losses = []
    best_valid_class_losses = [None for i in range(4)]
    for epoch in range(epochs):
        ...
        model.eval()
        with torch.no_grad():
            tau_thresholds = [0.1, 0.2, 0.3, 0.4,
            ...
            for i in range(4):
                ...
                if (best_valid_class_losses[i] == None) or (eval_class_losses[i] < best_valid_class_losses[i]):
                    ...
                    if early_stopping_per_class[i] == False:
                        ...
                        model_file_path = "/".join(["/app/timeseries/multiclass_src/models/wine-poc",
...
python3 wine-poc.py --epochs=10000 --loss="approx-f1" --run_name="poc-af1-0.1" --cuda=0 --train_tau=0.1 --batch_size=1024 --patience=100 --output_file="poc_results.json"
python3 wine-poc.py --epochs=10000 --loss="approx-f1" --run_name="poc-af1-0.125" --cuda=0 --train_tau=0.125 --batch_size=1024 --patience=100 --output_file="poc_results.json"
python3 wine-poc.py --epochs=10000 --loss="approx-f1" --run_name="poc-af1-0.2" --cuda=0 --train_tau=0.2 --batch_size=1024 --patience=100 --output_file="poc_results.json"
python3 wine-poc.py --epochs=10000 --loss="approx-f1" --run_name="poc-af1-0.3" --cuda=0 --train_tau=0.3 --batch_size=1024 --patience=100 --output_file="poc_results.json"
python3 wine-poc.py --epochs=10000 --loss="approx-f1" --run_name="poc-af1-0.4" --cuda=0 --train_tau=0.4 --batch_size=1024 --patience=100 --output_file="poc_results.json"

python3 wine-poc.py --epochs=10000 --loss="approx-f1" --run_name="poc-af1-0.5" --cuda=1 --train_tau=0.5 --batch_size=1024 --patience=100 --output_file="poc_results.json"
python3 wine-poc.py --epochs=10000 --loss="approx-f1" --run_name="poc-af1-0.6" --cuda=1 --train_tau=0.6 --batch_size=1024 --patience=100 --output_file="poc_results.json"
python3 wine-poc.py --epochs=10000 --loss="approx-f1" --run_name="poc-af1-0.7" --cuda=2 --train_tau=0.7 --batch_size=1024 --patience=100 --output_file="poc_results.json"
python3 wine-poc.py --epochs=10000 --loss="approx-f1" --run_name="poc-af1-0.8" --cuda=2 --train_tau=0.8 --batch_size=1024 --patience=100 --output_file="poc_results.json"
python3 wine-poc.py --epochs=10000 --loss="approx-f1" --run_name="poc-af1-0.9" --cuda=2 --train_tau=0.9 --batch_size=1024 --patience=100 --output_file="poc_results.json"
