...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if run_name: 
        ...
        tensorboard_path = "/".join("es-tensorboard", experiment_name)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if lowest_valid_loss is None or valid_loss < lowest_valid_loss: 
            ...
            fname = "/".join(["deep1-early-stopping", str(args.run_name) + "-" + "model_best.pth.tar"])
...
def save_checkpoint(state, is_best, filename='es_af1_checkpoint.pth.tar'):
    torch.save(state, filename)
    if is_best:
        shutil.copyfile(filename, 'es_af1_model_best.pth.tar')
...
'''
python3 grace-main-af1.py --gpu 1 --run_name es-af1 /app/timeseries/data/imagenet-data


Currently on Deep1: 
Finished the other runs. 

Running CE, AF1, 0.1, 0.2 with early stopping 0.125,
